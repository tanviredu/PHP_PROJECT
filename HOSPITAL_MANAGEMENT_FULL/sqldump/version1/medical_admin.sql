...
ALTER TABLE `department`
  ADD PRIMARY KEY (`department_head`),
...
--
ALTER TABLE `department`
  ADD CONSTRAINT `department_ibfk_1` FOREIGN KEY (`department_name`) REFERENCES `doctor` (`name`) ON DELETE CASCADE ON UPDATE CASCADE;
