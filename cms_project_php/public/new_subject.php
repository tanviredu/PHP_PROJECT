    ...
    ?>
      ...
      <ul class="sidebar navbar-nav">
        <li class="nav-item active">
            ...
            <b><font color="white"></br>&nbsp;&nbsp;&nbsp;&nbsp;CREATE NEW SUBJECT</b></font>
                            ...
                            <div class="card-body p-3">
                                ...
                                <div class="form-group">
                                    <div class="input-group mb-2">
                                        ...
                                        <input type="text" class="form-control" id="nombre" name="menu_name" placeholder="Enter subject name ">
                                    </div>
                                </div>
                                <div class="form-group">
                            ...
                            for ($count=1; $count<=$subject_count+1 ; $count++) { 
                              echo "<option value='{$count}'>{$count}</option>";
                                ...
                                <div class="form-group">
                                   <label >Visible:</label>
                                   <div class="checkbox">
                                      <label><input type="checkbox" name="visible" value="0">No</label>
                                    </div>
                                    <div class="checkbox">
                                      <label><input type="checkbox" name="visible" value="1">Yes</label>
                                    </div>
                                </div>
